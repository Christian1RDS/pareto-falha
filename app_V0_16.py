...
st.set_page_config(page_title="AGCO | Pareto QG09 V0.16", page_icon="📊", layout="wide")
APP_VERSION = "V0.16"
DB = "pareto_qg09_v016.db"
POSTO_FIXO = "QG09"
LOGO_CANDIDATES = [
    "agco_logo.png", "AGCO_logo.png", "agco-logo.png", "logo_agco.png", "logo.png",
    "AGCO.png", "agco.png", "agco_corporate_logo.png", "AGCO_Corporate_Logo.png",
]
...
st.markdown(f"<div class='agco-header'>{logo_html()}<div class='head-title'><h1>Pareto de Falhas QG09</h1><p>Versão {APP_VERSION}: carregamento flexível do logo AGCO e Pareto clássico com linha de 80%.</p><span class='badge'>D1_GERAL</span><span class='badge'>Pareto 80%</span><span class='badge'>Logo flexível</span><span class='badge'>QG09 fixo</span></div></div>",unsafe_allow_html=True)
